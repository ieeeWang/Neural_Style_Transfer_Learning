...
def model_nn(sess, cache, train_step, input_image, num_iterations = 200, output_dir = "output_up/5L2_"):
...
image_C = "portogal2.jpg"
image_S = "image_style\\shanshui3.jpg"
folder_out = "output"

start_time = time.time()
NST_main(model, folder_in, folder_out, image_C, image_S, S_weit ='up', N = 2000)
elapsed_time = time.time() - start_time
print('elapsed_time:', elapsed_time)
 

#%% plot figure
outpath = "output/prage_conv5_2up_"
...
axs[0, 0].imshow(out_image1)
axs[0, 1].imshow(out_image3)
axs[1, 0].imshow(out_image3)
axs[1, 1].imshow(out_image4)


#%% comparing hyper-parameters amonst 6 figs
outpath = "demo_photos/good/portogal2_"
